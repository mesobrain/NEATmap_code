...
def seg3d_to_2d(data_path, save_path, index=0):
    ...
    for i in range(1, len(os.listdir(data_path)) + 1):
        image = sitk.ReadImage(os.path.join(data_path, 'Z{:05d}_seg.tif'.format(i)))
...
if __name__ == "__main__":
    ...
    path = r'R:\WeijieZheng\Vessel_data\20220913_AI9_3_1'
    # data_path = os.path.join(path, 'whole_brain_pred_post_filter')
    data_path = os.path.join(path, 'whole_brain_pred_561nm')
